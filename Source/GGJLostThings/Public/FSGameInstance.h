 ...
 */
UCLASS()
class GGJLOSTTHINGS_API UFSGameInstance : public UGameInstance
{
	GENERATED_BODY()
...
public:
	...
	TMap<FPrimaryAssetId, FFSItemData> DefaultInventory;
	...
	void AddDefaultInventory(UFSSaveGame* SaveGame, bool bRemoveExtra = false);

	/** Returns true if this is a valid inventory slot */
	UFUNCTION(BlueprintCallable, Category = Inventory)
	bool IsValidItemSlot(FFSItemSlot ItemSlot) const;
	...
	UFSSaveGame* GetCurrentSaveGame();
